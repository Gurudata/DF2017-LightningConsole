({
     ...
     */
    firePageChangeEvent : function( component, pageNumber, pageSize, scrollUp ) {
    ...
    getNextPage : function( component ) {
        ...
        this.firePageChangeEvent( component, pageNumber, pageSize , false);
    ...
    /**
     * Designed to be called by the renderer during infinite scrolling events.
     * Decrements the page number then fires page change event.
     */
    getPreviousPage : function( component ) {
        console.log('Inside get previous page');
        var pageNumber = component.get( 'v.pageNumber' );
        var pageSize = component.get( 'v.pageSize' );
        ...
        this.firePageChangeEvent( component, pageNumber, pageSize, true);
       } 
